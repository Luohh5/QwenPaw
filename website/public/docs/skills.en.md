...
1. **Import built-ins**.
   ...
   | **mailbox**                   | Unified entry for all email tasks: list, read, search, send, reply, forward, and organize mail via the qwenpawmail-mcp server (12 providers, IMAP/SMTP). | Built-in                                                   |
